...
const Memo = () => {
    ...
    const {data: memo, isLoading} = useMemo();
    ...
    return (
        <div className="min-h-screen flex flex-col bg-background">
            ...
            <main className="flex-1">
                        ...
                        <div className="max-w-5xl mx-auto">
                            <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start">
                                ...
                                <div className="flex justify-center">
                                    <div
                                        className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl p-8 w-full max-w-sm aspect-[3/4] flex flex-col items-center justify-center border border-border/50">
                                        <div
                                    ...
                                    <div className="pt-4">
                                        <Button
                                            ...
                                            onClick={
                                                async () => {
                                                    try {
                                                        await downloadFile(memo?.downloadUrl)
                                                    } catch (error) {
                                                        toast({
                                                            title: "Ошибка",
                ...
                {/* Related Articles */}
                {memo?.relatedArticles && <section className="py-12 md:py-16 bg-muted/30">
                  <div className="container mx-auto px-4">
                    <div className="max-w-5xl mx-auto">
                      ...
                      <div className="grid sm:grid-cols-3 gap-4">
                          {memo.relatedArticles.map((article) => (
